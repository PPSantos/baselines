...
def save_variables(save_path, variables=None, sess=None, scope_name=None):
    import joblib
    sess = sess or get_session()
    variables = variables or tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope=scope_name)
...
def load_variables(load_path, variables=None, sess=None, scope_name=None):
    import joblib
    sess = sess or get_session()
    variables = variables or tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, scope=scope_name)
